<div class="row">
    ...
    <div class="col-md-12" style="padding-top: 20px;">
        <table id="table-content" class="table table-bordered table-hover">
            <thead>
            <tr>
                <th class="center title_td">Signup Date</th>
                <th class="center title_td">Phone Number</th>
                <th class="center title_td">Name</th>
                <th class="center title_td">Bank</th>
                <th class="center title_td">Account Number</th>
                <th class="center title_td">Birthday</th>
                <th class="center title_td">Gender</th>
                <th class="center title_td">Signup ID</th>
                <th class="center title_td">Device</th>
                <th class="center title_td">Point</th>
            </tr>
            </thead>
            <tbody>
            </tbody>
...
<script>
    ...
    $(function () {
        ...
        table = eTable.dataTable({
            ...
            "ajax": { // define ajax settings
                "url": "<?=site_url('User/getTableData')?>", // ajax URL
                "type": "POST",
                "beforeSend": function () {
                },
                "data": function (data) {
            ...
            "createdRow": function (row, data, dataIndex) {
                $('td:eq(1)', row).html('<a class="text-underline" onclick="detail(' + data["uid"] + ')">' + data[1] + '</a>');
            },
    ...
    function detail(uid) {
        location.href = "<?= site_url("User/detail")?>?uid=" + uid;
    }
</script>