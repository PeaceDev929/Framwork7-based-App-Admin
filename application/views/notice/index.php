<div class="row">
    <div class="col-md-12" style="margin-top: 20px; display: flex">
        ...
        <div style="flex: 1;" class="text-right">
            <a class="btn btn-primary" style="width: 100px;" href="<?= site_url('Notice/detail') ?>""><i
    ...
    <div class="col-md-12" style="padding-top: 20px;">
        <table id="table-content" class="table table-bordered table-hover">
            <thead>
            <tr>
                <th class="center title_gray" width="60px;">No</th>
                <th class="center title_gray">Title</th>
                <th class="center title_gray" width="100px"></th>
            </tr>
            </thead>
            <tbody>
            </tbody>
    ...
    $(function () {
        ...
        table = eTable.dataTable({
            ...
            "ajax": { // define ajax settings
                "url": "<?=site_url('Notice/getTableData')?>", // ajax URL
                "type": "POST",
                "beforeSend": function () {
                },
                "data": function (data) {
            ...
            "createdRow": function (row, data, dataIndex) {
                ...
                $('td:eq(2)', row).html('<button class="btn btn-primary" onclick="deleteItem(' + data["uid"] + ')">Delete</button>');
