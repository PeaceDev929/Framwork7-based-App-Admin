<div class="row">
            ...
            <tr>
                <td style="width: 150px;" class="padding_none center">
                    <select class="form-control select_format" id="sel_search_type">
                        ...
                        <option value="2">Board Title</option>
                    </select>
                </td>
    ...
    <div class="col-md-12" style="padding-top: 20px;">
        <table id="table-content" class="table table-bordered table-hover">
            <thead>
            <tr>
                <th class="center title_gray" width="110px;">신고날자</th>
                <th class="center title_gray" width="30%">신고자 Nickname</th>
                <th class="center title_gray">Board</th>
            </tr>
            </thead>
            <tbody>
            </tbody>
    ...
    $(function () {
        ...
        table = eTable.dataTable({
            ...
            "ajax": { // define ajax settings
                "url": "<?=site_url('BoardReport/getTableData')?>", // ajax URL
                "type": "POST",
                "beforeSend": function () {
                },
                "data": function (data) {
