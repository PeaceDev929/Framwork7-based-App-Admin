    ...
    <div class="col-md-12" style="padding-top: 20px;">
        <table id="table-content" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <th class="center title_gray">비 Mano리용자</th>
                <th class="center title_gray">루적회수</th>
                <th class="center title_gray">신고자 Nickname</th>
            </tr>
            </thead>
            <tbody>
            </tbody>
    ...
    $(function () {
        ...
        table = eTable.dataTable({
            ...
            "ajax": { // define ajax settings
                "url": "<?=site_url('Report/getTableData')?>", // ajax URL
                "type": "POST",
                "beforeSend": function () {
                },
                "data": function (data) {
